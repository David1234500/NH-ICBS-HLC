...
public:
    ...
    static dynamics::data::Pose2DWithError computeBestFit(Pose2D current_pose, PoseByIndex tpi, Pose2D target_pose, float timestep, float allowed_speed_deviation);
